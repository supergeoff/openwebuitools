...
source: https://github.com/Classic298/open-webui-plugins/tree/2adbef74cad4c8ab907d612fcbf51d26374734b7/inline-visualizer-v2 (vendored; skill renamed visualize -> inline_visualizer)
description: Renders interactive HTML/SVG visualizations inline in chat. Requires "iframe Sandbox Allow Same Origin" to be enabled in Open WebUI Settings -> Interface. For design instructions, the model should call view_skill("inline_visualizer").
"""
...
class Tools:
    ...
    async def visualize(
        ...
        **If the user did not explicitly ask for a visual artifact, do not call visualize().**
        ...
        IMPORTANT:
        BEFORE CALLING THIS TOOL, YOU MUST: Call view_skill("inline_visualizer") FIRST.
        You MUST call view_skill("inline_visualizer") first.
        The inline_visualizer skill contains a mandatory handbook/tutorial with important rules for rendering, layout, SVG setup, chart patterns, colors, interactivity, and common failure points.
